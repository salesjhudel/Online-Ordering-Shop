...
<div id="contents" style="margin-bottom:0px; margin-right;0px; width:1040px; font-size:0px;">
		<?php
  if($user_id){
  ...
  ?>
  	...
  	<div id="contents" style="margin-left;0px; width:700px; padding:70px 105px 20px 130px;  font-size:10px; background-color:white;">
	<h1> 
    <?php
...
<img src="../reservation/img/products/login.png" width="280" height="60"></img>
