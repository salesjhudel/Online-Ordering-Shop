...
<div style="float:left; width:500px; background-color:#191919; padding:20px; margin-right:0px; position:fixed;">
<?php
...
<div style="float:left; width:500px; height:180px; background-color:white; padding:20px; margin-right:0px; margin-top:126px;  position:fixed; ">
		
</div>

<div style="float:left; width:500px; height:60px; background-color:#7AC2E3; padding:20px; margin-right:0px; margin-top:120px;  position:fixed; ">
		...
		<div style=" margin-right:170px; text-decoration:none; " >
			...
			<a style='text-decoration:none; float:left; font-size:20px; font-weight:bold;  color:white;'>Settings</a>
				<br><br><br><br>
					<div style ="padding:50px; margin-right:0px; margin-top:20px;">
...
<div style="float:left; background-color:lightblue; height:120px;"></div>
		...
		<div style=" float:right; width:450px; margin-left:11110px; background-color:#191919; padding:20px; margin-top:0px;">
