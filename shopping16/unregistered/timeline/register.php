...
<style>
body {
	background: url(../include/home/images/bg-body.gif) repeat;
...
<body>
	...
	<div id="contents" style="margin:50px 0px 220px 420px ; padding:20px; height:580px;width:500px; font-size:15px; font-family:arial; color:#4E4D4D; padding:20px; background-color:grey;">


	<form action="register.php" method="POST" role="form" style="width:300px; ">
    <h3></h3>
    <h4 style="font-size:50px; width:550px; color:white; margin-bottom:20px; margin-left:135px;"><strong>Register</strong></h4>
